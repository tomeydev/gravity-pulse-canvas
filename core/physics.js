...
export const MOVE_SPEED = 100; // m/s
export const AIR_MOVE_SPEED = 8; // m/s
export const MAX_SPEED_X = 80; // m/s
export const MAX_JUMP_CHARGE = 80 ;
export const JUMP_POWER = 8; // m/s
export const DOUBLE_JUMP_POWER = 6; // m/s
